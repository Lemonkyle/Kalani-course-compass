...
const COURSES = [
  ...
  { id:"ALG2",    code:"MAX1200", name:"Algebra 2",                            dept:"Mathematics", credits:1.0, gradeLevel:[10,11],  prereqs:["ALG1","GEO"],  gradCategory:"math", gradCredits:1.0,
  ...
  { id:"PHYS",     code:"SPH5603",  name:"Physics",                           dept:"Science", credits:1.0, gradeLevel:[11,12],   prereqs:["GEO","ALG1","ALG2"],    gradCategory:"science", gradCredits:1.0, teacherSigRequired:true,
  ...
  { id:"LAS",        code:"TAS3000", name:"Large Animal Systems",             dept:"CTE", ctePath:"AFNR", credits:1.0, gradeLevel:[11,12],    prereqs:["AFNR1","SAS"], gradCategory:"wlfa", gradCredits:1.0, teacherSigRequired:true,
  ...
  { id:"WBL_ANIMAL", code:"TAS4000", name:"Animal Systems: Work-Based Learning", dept:"CTE", ctePath:"AFNR", credits:1.0, gradeLevel:[12], prereqs:["AFNR1","LAS"], gradCategory:"wlfa", gradCredits:1.0, teacherSigRequired:true,
  ...
  { id:"AGRI_PROD",  code:"TAB3000", name:"Agriculture Production & Agri-Business", dept:"CTE", ctePath:"AFNR", credits:1.0, gradeLevel:[11,12], prereqs:["AFNR1","AGRI_BIZ1"], gradCategory:"wlfa", gradCredits:1.0, teacherSigRequired:true,
  ...
  { id:"AGRI_PROD2", code:"TAB4000", name:"Agriculture Production & Agri-Business 2", dept:"CTE", ctePath:"AFNR", credits:1.0, gradeLevel:[12], prereqs:["AFNR1","AGRI_BIZ1","AGRI_PROD"], gradCategory:"wlfa", gradCredits:1.0, teacherSigRequired:true,
  ...
  { id:"ENT2", code:"TBE3000", name:"Entrepreneurship 2",                     dept:"CTE", ctePath:"Business", credits:1.0, gradeLevel:[11,12],    prereqs:["BIZ1","ENT1"], gradCategory:"wlfa", gradCredits:1.0,
  ...
  { id:"ENG2",     code:"TAE3000", name:"Engineering Tech 2",                 dept:"CTE", ctePath:"Engineering", credits:1.0, gradeLevel:[11,12], prereqs:["ENG_FOUND","ENG1"], gradCategory:"wlfa", gradCredits:1.0,
  ...
  { id:"ENG3",     code:"TAE4000", name:"Engineering Technology 3",           dept:"CTE", ctePath:"Engineering", credits:1.0, gradeLevel:[12], prereqs:["ENG_FOUND","ENG1","ENG2"], gradCategory:"wlfa", gradCredits:1.0,
  ...
  { id:"THERAPEUTIC", code:"THP3000", name:"Principles of Therapeutic Services", dept:"CTE", ctePath:"Health Services", credits:1.0, gradeLevel:[11,12], prereqs:["HLTH_FOUND","ADV_HLTH"], gradCategory:"wlfa", gradCredits:1.0,
            ...
            <div style={{ maxWidth:"840px", margin:"32px auto 0", padding:"0 24px" }}>
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:"8px" }}>
                {DEPTS.filter(d=>d!=="All").map(d=>(
                  <div key={d} onClick={()=>{ setFilterDept(d); setFilterCtePath("All CTE"); setFilterFineArts("All Fine Arts"); setFilterMisc("All Miscellaneous"); setPage("catalog"); }}
